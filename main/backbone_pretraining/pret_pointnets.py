...
from cdbs.utils_networks.pretrain_wrappers import PointNetS_Pretrainer, ftr_trans_regularizer
dataset_folder = os.path.join(data_root, 'ShapeNetCore')
ckpt_name = 'pret_pointnets'
...
dim_pwf = 2880
dim_cdw = 2048
net = PointNetS_Pretrainer(dim_pwf, dim_cdw, dim_vs_cdw).cuda()
max_lr = 5e-4
min_lr = 5e-6
num_epc = 600
