...
from cdbs.utils_networks.pretrain_wrappers import PointNetC_Pretrainer, ftr_trans_regularizer
dataset_folder = os.path.join(data_root, 'ShapeNetCore')
ckpt_name = 'pret_pointnetc'
...
dim_pwf = 1024
dim_cdw = 1024
net = PointNetC_Pretrainer(dim_pwf, dim_cdw, dim_vs_cdw).cuda()
max_lr = 1e-3
min_lr = 5e-6
num_epc = 600
